        ...
        <contentCard class="mt-2 mb-4">
            ...
            <div class="flex grid grid-cols-1 md:grid-cols-3 items-center pt-4 justify-center">
                    <div class="items-center my-2">
                        <div class="font-sans text-sm font-thin tracking-wide textteal-700 text-center">
                            BEANS WEIGHT <br/>
                            BEFORE ROAST (KG)
                        </div>
                        <div class="font-sans font-medium text-3xl tracking-wide textteal-600 text-center">
